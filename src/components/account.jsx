      ...
      <div style={{ position: "relative", display: "inline-block", top: "-7px", right:'-8px' }}>
        ...
        {showAccountOverlay && (
          <div style={accountCardStyles}>
            ...
            <p style={{ margin: "0 32px 16px", fontSize: "14px", color: "#555", color: darkMode ? "#ddd" : "#555", }} >
              {currentUser?.email}
            </p>
            ...
            <div style={{ marginTop: "15px", fontSize: "14px", cursor:'pointer' }} className="form-check form-switch">
              <input
                type="checkbox"
                checked={darkMode}
