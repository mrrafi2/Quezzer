...
export default function Nav() {
  ...
  // Button click handler with click animation
      ...
      <div style={triggerButtonContainerStyle}>
        <button style={triggerButtonStyle} onClick={handleButtonClick}>
          <i
            ...
            style={{ fontSize: windowWidth < 768 ? '12px' : '15px' }}
          ></i>
        </button>
      </div>
      ...
      <div style={offcanvasStyle}>
        ...
        <div style={offcanvasBodyStyle}>
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            ...
            <hr  style={{backgroundColor:"white",height:"2px", marginBottom:"25px", marginTop:"25px",opacity:0.8}}/>
