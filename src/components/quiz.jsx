...
const categories = [
  ...
  { 
    ...
    gradient: "linear-gradient(45deg, #c8ad7f, #8b6e4f)" 
  },
  { 
    name: "Science & Nature", 
    image: science, 
    motto: "Uncover nature's secrets with every question", 
    gradient: "linear-gradient(45deg, #a8e063, #56ab2f)" 
  },
  { 
    name: "Geography", 
    image: geo, 
    motto: "Map out your trivia adventure", 
    gradient: "linear-gradient(45deg, rgb(169, 182, 102), rgb(202, 202, 0))" 
  },
  { 
    name: "Literature", 
    image: Ltrc, 
  ...
  { 
    ...
    gradient: "linear-gradient(45deg,rgb(211, 161, 255),rgb(133, 71, 255))" 
  },
  { 
    name: "Sports", 
    image: sports, 
  ...
  { 
    ...
    gradient: "linear-gradient(45deg, #b0bec5, #eceff1)" 
  },
  { 
    name: "Food & Drink", 
    image: food, 
  ...
  { 
    ...
    gradient: "linear-gradient(45deg, #a2d9ff, #c8e6f2)" 
  },
  { 
    name: "Space & Astronomy", 
    image: space, 
    motto: "Blast off into cosmic challenges", 
    gradient: "linear-gradient(45deg, #4f83cc, #bbdefb)" 
  },
  { 
    name: "Animals & Wildlife", 
    image: animal, 
    motto: "Go wild with trivia and challenge", 
    gradient: "linear-gradient(45deg, #7b920a, #add100)" 
  },
];
    ...
    <div className={`container mt-4 ${darkMode ? "dark" : ""}`}>
      ...
      <div className="row ms-0">
        {categories.map((cat, index) => (
          ...
          >
            <Link
              to={`/labels/${encodeURIComponent(cat.name)}`}
            ...
            >
              <div className={`quiz-card shadow ${visibleCards[index] ? "visible" : ""}`}>
                ...
                />
                <div
                  className={`quiz-card-overlay ${visibleCards[index] ? "active" : ""}`}
                >
